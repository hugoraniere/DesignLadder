  ...
  return (
    <div className="min-h-screen bg-white text-black">
      ...
      <div className="fixed top-6 right-6 flex items-center gap-3 z-50">
        <a
          href="#app"
          className="flex items-center space-x-2 px-4 py-2 bg-black text-white hover:bg-gray-800 transition-colors font-bold text-sm"
        >
          <span>{language === 'en' ? 'Access App' : 'Acessar App'}</span>
